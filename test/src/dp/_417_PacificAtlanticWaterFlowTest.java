...
public class _417_PacificAtlanticWaterFlowTest {
    ...
    _417_PacificAtlanticWaterFlow target;

    @Before
    public void before() throws Exception {
        target = new _417_PacificAtlanticWaterFlow();
    }
    ...
    private int[][] converToArray(List<List<Integer>> list) {
        int[][] arr = new int[list.size()][2];
        for (int i = 0; i < arr.length; i++) {
            List<Integer> coordiante = list.get(i);
            arr[i][0] = coordiante.get(0);
            arr[i][1] = coordiante.get(1);
        }
        return arr;
    }

    private void assertArray(int[][] expected, List<List<Integer>> actual) {
        int[][] arr = converToArray(actual);
    ...
    @Test
    public void testPacificAtlantic1() throws Exception {
        int[][] heights = {{1, 2, 2, 3, 5}, {3, 2, 3, 4, 4}, {2, 4, 5, 3, 1}, {6, 7, 1, 4, 5}, {5, 1, 1, 2, 4}};
        List<List<Integer>> list = target.pacificAtlantic(heights);
        int[][] expected = {{0, 4}, {1, 3}, {1, 4}, {2, 2}, {3, 0}, {3, 1}, {4, 0}};
        assertArray(expected, list);
    }

    @Test
    public void testPacificAtlantic2() throws Exception {
        int[][] heights = {{1}};
        List<List<Integer>> list = target.pacificAtlantic(heights);
        int[][] expected = {{0, 0}};
        assertArray(expected, list);
    ...
    @Test
    public void testPacificAtlantic3() throws Exception {
        int[][] heights = {{1, 2, 3}, {8, 9, 4}, {7, 6, 5}};
        List<List<Integer>> list = target.pacificAtlantic(heights);
        int[][] expected = {{0, 2}, {1, 0}, {1, 1}, {1, 2}, {2, 0}, {2, 1}, {2, 2}};
        assertArray(expected, list);
    }

    @Test
    public void testPacificAtlantic4() throws Exception {
        int[][] heights = {{11, 2, 11, 0, 15, 12, 4, 15, 0, 14, 11, 3, 19, 11, 5, 11, 18, 19, 4, 3, 11, 1, 9, 17, 5, 2, 15, 18, 11, 15},
        ...
        List<List<Integer>> list = target.pacificAtlantic(heights);
        int[][] expected = {{0, 29}, {1, 28}, {2, 27}, {2, 28}, {3, 27}, {34, 2}, {35, 2}, {35, 3}, {36, 1}, {36, 2}, {37, 0}, {37, 2}, {37, 3}, {38, 0}, {38, 2}};
        assertArray(expected, list);
    }
}
